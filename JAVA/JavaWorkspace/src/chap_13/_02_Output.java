...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%+6d%n", 1234); // _+1234 (항상 부호 표시)
        ...
        System.out.printf("%.2f%n", Math.PI); // 3.14 (2번째에서 끊음)
        System.out.printf("%6.2f%n", Math.PI); // __3.14 (6만큼의 공간 확보 후 2번째에서 끊음)
        System.out.printf("%-6.2f%n", Math.PI); // 3.14-- (6만큼의 공간 확보 후 2번째에서 끊음, 왼쪽 정렬)
        System.out.printf("%06.2f%n", Math.PI); // 003.14 (6만큼의 공간 확보 후 2번째에서 끊음, 빈공간 0)
        System.out.printf("%+6.2f%n", Math.PI); // _+3.14 (6만큼의 공간 확보 후 2번째에서 끊음, 부호 표시)
        ...
        System.out.printf("%6.2s%n", "Java"); // ____Ja (6자리 공간 확보하고 우측, 2글자만)
        System.out.printf("%-6.2s%n", "Java"); // Ja____ (6자리 공간 확보하고 좌측 정렬해서 2글자만)
